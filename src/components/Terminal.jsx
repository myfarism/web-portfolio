  ...
  const commands = {
    ...
    whoami: () => ({
      output: [
        ...
        '║ Education: S1 Informatics (GPA 3.56)  ║',
        '║ Current: Asa Kreasi Interasia         ║',
        '╠════════════════════════════════════════╣',
        '║ Specialization:                       ║',
        '║  • Node.js & REST APIs                ║',
    ...
    setHistory([
      { 
        ...
        content: isMobile ? [
          ...
          '',
          '╔═══════════════════════════════════════════════════╗',
          '║  Welcome to Faris Portfolio Terminal v2.1.0     ║',
          '║  Backend & Android Developer                     ║',
          '║  Type "help" to see available commands           ║',
          '║  💡 Easter eggs hidden - try fun commands!       ║',
          '╚═══════════════════════════════════════════════════╝',
          ''
        ]
      }
